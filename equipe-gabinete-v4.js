/* Equipe v4 — ponte para o gerenciador cloud atual */
(function(){'use strict';
...
function open(){
  ...
  const old=document.getElementById('equipeV6Loader');if(old)return;
  const s=document.createElement('script');s.id='equipeV6Loader';s.src='equipe-gabinete-v6.js?v=12002';
